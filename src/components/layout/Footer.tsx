      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center items-start">
        ...
        <div className="flex flex-col sm:block space-y-4 sm:space-y-0">
          <p className="text-[#8a919e] text-sm mt-2 font-proxima-nova">
            ...
            <span className="hidden sm:inline mx-4 text-[4px] text-[#d0d2d8] inline-flex items-center"><i className="fa-solid fa-circle align-middle relative -top-[2px]"></i></span>
            <span className="hidden sm:inline"><a href="https://github.com/douvy/btc-tooling" className="text-[#8a919e] hover:text-[#8a919e]/90 transition-colors border-b border-[#8a919e] hover:border-[#8a919e]/90 pb-[1px]" target="_blank" rel="noopener noreferrer">Star on <i className="fa-brands fa-github ml-1"></i></a></span>
          </p>
          <p className="text-[#8a919e] text-sm font-proxima-nova mt-4 sm:hidden">
            <a href="https://github.com/douvy/btc-tooling" className="text-[#8a919e] hover:text-[#8a919e]/90 transition-colors border-b border-[#8a919e] hover:border-[#8a919e]/90 pb-[1px]" target="_blank" rel="noopener noreferrer">Star on <i className="fa-brands fa-github ml-1"></i></a>
          </p>
        </div>
      </div>
    </footer>
