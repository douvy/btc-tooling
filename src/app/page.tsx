...
const tweets = [
  {
    ...
    username: 'Bully',
    handle: 'BullyEsq',
    profileImage: 'bully.jpg',
    text: 'Literally every factor I can think of is lined up for a monster Bitcoin run over the next 6 months. Like every single one. \n\nI’ve been at this a while now and never seen the stars aligned like this. \n\nI’m strapped in an ready for launch. \n\nLet’s go.',
    time: '11:21 AM · MAY 11, 2025',
    link: 'https://x.com/BullyEsq/status/1921586478389363088',
    comments: 26,
    retweets: 23,
    likes: 250,
    views: 23400
  ...
  {
    id: '2',
    username: 'jez (blast era)',
    handle: 'Fapiizebel_ethtal3',
    profileImage: 'jez.jpg',
    text: 'the endgame for bitcoin is as the greatest collateral asset invented \n\ngold that you can store for free, and borrow against permissionlessly',
    time: '9:09 AM · MAY 11, 2025',
    image: 'jez-post.jpg',
    link: 'https://x.com/izebel_eth/status/1921553179973451834',
    comments: 34,
    retweets: 43,
    likes: 416,
    views: 60700
  },
  {
    ...
    username: 'CRG',
    handle: 'MacroCRG',
    profileImage: 'crg.jpg',
    text: '$BTC just jumped +40% and open interest is the same as it was at the bottom \n\nIncredible really',
    time: '1:42 AM · MAY 11, 2025',
    image: 'crg-post.jpg',
    link: 'https://x.com/MacroCRG/status/1921440683665019268',
    comments: 67,
    retweets: 149,
    likes: 1200,
    views: 69700
