...
const tweets = [
  {
    ...
    username: 'HORSE 🏴‍☠️',
    handle: 'TheFlowHorse',
    profileImage: 'horse.jpg',
    text: 'Look at the Coinbase volume profile of BTC from April 11th on. The amount of turnover up here in 3 days is equal to the amount we had in a 9 day range lower.',
    time: '3:42 PM · APR 25, 2025',
    image: 'horse-post.jpg',
    link: 'https://x.com/TheFlowHorse/status/1915899284760707251',
    comments: 24,
    retweets: 6,
    likes: 126,
    views: 12500
  },
  {
    ...
    text: '⚡️JUST IN: Strike to launch Bitcoin-backed lending "within days" - CEO Jack Mallers',
    time: '1:51 PM · APR 25, 2025',
    link: 'https://x.com/BTC_Archive/status/1915871253698593119',
    comments: 101,
    retweets: 170,
    likes: 1600,
    views: 65100
  },
  {
    ...
    text: 'You can still buy $BTC for less than $0.1 million.',
    time: '9:36 AM · APR 25, 2025',
    link: 'https://x.com/saylor/status/1915807109272277326',
    comments: 1000,
    retweets: 1600,
    likes: 14000,
    views: 520900
